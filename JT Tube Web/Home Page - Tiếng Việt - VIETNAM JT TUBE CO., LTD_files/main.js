...
window._wpemojiSettings = {
    ...
    "svgExt": ".svg",
    "source": {
        "concatemoji": "https:\/\/jttubevina.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.6.1"
    }
};
/*! Tập tin này được tự động tạo ra */
!function(i,n){
    var o,s,e;
    function c(e){
        try{
    ...
    "undefined" != typeof Promise && (o = "wpEmojiSettingsSupports", s = ["flag", "emoji"], n.supports = { everything: !0, everythingExceptFlag: !0 },
...
$(document).ready(function(){
    $('.slider').hover(
        function() { // Khi di chuột vào slider
            $(this).slick('slickPause'); // Dừng slider
        }, 
        function() { // Khi di chuột ra khỏi slider
            $(this).slick('slickPlay'); // Bắt đầu lại slider
        }
    );
});